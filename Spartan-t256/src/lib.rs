...
impl NIZK {
    ...
    pub fn verify(
        ...
        #[cfg(all(feature = "profile", feature = "t256", not(feature = "vesta")))]
        println!("Spartan verify() using curvve T-256");

        #[cfg(all(feature = "profile", feature = "vesta"))]
        println!("Spartan verify() using curve vesta");
